local doc = config.command_start .. config.locale.plugins.wikipedia.command .. ' <' .. config.locale.arguments.topic .. '>\n' .. config.locale.plugins.wikipedia.help

local triggers = {
	'^' .. config.command_start .. config.locale.plugins.wikipedia.command,
...
local action = function(msg)
	...
	local wurl = 'http://' .. config.locale.plugins.wikipedia.language .. '.wikipedia.org/w/api.php?action=query&prop=extracts&format=json&exchars=4000&exsectionformat=plain&titles='
