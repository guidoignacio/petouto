local doc = config.command_start .. config.locale.plugins.currency.command ..
			' <' .. config.locale.arguments.from .. '>' .. ' <' .. config.locale.arguments.to .. '>' .. ' [' .. config.locale.arguments.amount .. ']\n' ..
			config.locale.plugins.currency.help

local triggers = {
	'^' .. config.command_start .. config.locale.plugins.currency.command
}
